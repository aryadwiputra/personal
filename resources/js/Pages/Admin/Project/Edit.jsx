    ...
    return (
        <>
            <div className="flex items-center justify-between">
                <h2 className="text-2xl font-semibold leading-tight">Edit {project.title}</h2>
            </div>
...
Edit.layout = page => <DashboardLayout children={page} title="Edit project" />
